function [B,U1,g,D,Q1T,r] = OLM_ROBUST_STEP_1(parameters)
% OLM_ROBUST_STEP_1 First step of robust LM
%
% [B,U1,g,D,Q1T] = OLM_ROBUST_STEP_1(a,na,data,n) computes the matrices [B],
...
%
% see also OLM_ROBUST_STEP_2, OLM_ROBUST_STEP_LAMBDA
